...
export default function LocationQuotientLoading() {
  return (
      ...
      <Card className="border border-[var(--bber-border)] bg-white py-0 shadow-sm">
        <CardHeader className="px-6 pt-6">
          <CardTitle className="font-display text-3xl text-[var(--bber-red)]">
            Loading location quotient portfolio
          </CardTitle>
        </CardHeader>
        <CardContent className="px-6 pb-6">
          <p className="text-sm leading-7 text-[var(--bber-ink)]/78">
            Fetching QCEW employment totals, industry series, and comparison
            metadata from the BBER REST API.
          </p>
        </CardContent>
      </Card>
    </SectionPageShell>
