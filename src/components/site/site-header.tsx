  ...
  return (
    <header className="border-b border-[var(--bber-border)] bg-white">
      <div className="bg-[var(--bber-sand)]">
        <div className="mx-auto flex w-full max-w-[1200px] flex-wrap items-center justify-end gap-x-5 gap-y-2 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-[var(--bber-red)] sm:px-6 lg:px-8">
